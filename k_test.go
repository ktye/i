...
func Test360(t *testing.T) {
	...
	Tx := []struct {
		...
		{"2 1 1⍉2 3 4⍴⍳24", []int{3, 2}, []int{1, 13, 6, 18, 11, 23}},
		{"1 1 2⍉2 3 4⍴⍳24", []int{2, 4}, []int{1, 2, 3, 4, 17, 18, 19, 20}},
		{"1 1 2⍉3 2 4⍴⍳24", []int{2, 4}, []int{1, 2, 3, 4, 13, 14, 15, 16}},
		{"⍴2 4 1 3⍉2 3 4 5⍴1", []int{4}, []int{4, 2, 5, 3}},
		{"⍴⍴(⍳0)⍉5", []int{1}, []int{0}},
