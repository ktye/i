...
func TestP(t *testing.T) {
	testCases := []struct {
		...
		{"1 2 3[0 2]", l{".", zv{1, 2, 3}, l{nil, zv{0, 2}}}, zv{1, 3}},
		{"`a`b`c[2]", l{".", sv{"a", "b", "c"}, l{nil, z2}}, "c"},
		{"(1;2;3)[0 1]", l{".", l{nil, z1, z2, z3}, l{nil, zv{0, 1}}}, zv{1, 2}},
		{"(1;(2;3);4)[1;1]", l{".", l{nil, z1, l{nil, z2, z3}, z4}, l{nil, z1, z1}}, z3},
		{"+[3;4]", l{".", "+", l{nil, z3, z4}}, c(7, 0)},
		{`a:+;a[1;2]`, l{";", l{":", "a", "+"}, l{".", "a", l{nil, z1, z2}}}, z3},
		...
		{`{x+y}[1;2]`, l{".", l{"λ", l{l{"+", "x", "y"}}}, l{nil, z1, z2}}, z3},
		{`{y+2*x}\1 2 3`, l{l{`\`, l{"λ", l{l{"+", "y", l{"*", z2, "x"}}}}}, zv{1, 2, 3}}, zv{1, 4, 11}},
		{`a:1;{a:2}[];a`, l{";", l{":", "a", z1}, l{".", l{"λ", l{l{":", "a", z2}}}, l{nil}}, "a"}, z1},
		{`a:1;{a::2}[];a`, l{";", l{":", "a", z1}, l{".", l{"λ", l{l{"::", "a", z2}}}, l{nil}}, "a"}, z2},
		{`$[1;2;3]`, l{".", "$", l{nil, z1, z2, z3}}, z2},
		{`$[0;2;0;3;4]`, l{".", "$", l{nil, z0, z2, z0, z3, z4}}, z4},
		{`{$[x>1;x*o x-1;1]}8`, l{l{"λ", l{l{".", "$", l{nil, l{">", "x", z1}, l{"*", "x", l{"o", l{"-", "x", z1}}}, z1}}}}, c(8, 0)}, z(40320)},
		{`{$[x>100;x;∇ x+1]}1`, l{l{"λ", l{l{".", "$", l{nil, l{">", "x", c(100, 0)}, "x", l{"∇", l{"+", "x", z1}}}}}}, z1}, c(101, 0)},
		{`{$[x>100;x;∇[x+1]]}1`, l{l{"λ", l{l{".", "$", l{nil, l{">", "x", c(100, 0)}, "x", l{".", "∇", l{nil, l{"+", "x", z1}}}}}}}, z1}, c(101, 0)},
	}
