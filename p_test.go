...
func TestP(t *testing.T) {
	testCases := []struct {
		...
		//{"a:1 2;a[1]:3", l{";", l{l{":", "a", l{nil, z1, z2}}}, l{":", l{"a", z1}, z3}}, zv{1, 3}},
		//{"a:1 2;a[1]+:3", l{";", l{l{":", "a", l{nil, z1, z2}}}, l{"+:", l{"a", z1}, z3}}, zv{1, 5}},
		...
		{`a:1;{a+::2}[];a`, l{";", l{":", "a", z1}, l{l{"λ", l{l{"+::", "a", z2}}}, nilad(true)}, "a"}, z3},
		{`$[1;2;3]`, l{"$", z1, z2, z3}, z2},
		...
		{`{$[x>100;x;∇[x+1]]}1`, l{l{"λ", l{l{"$", l{">", "x", c(100, 0)}, "x", l{"∇", l{"+", "x", z1}}}}}, z1}, c(101, 0)},
		{`{-x}@2 3`, l{"@", l{"λ", l{l{"-", "x"}}}, zv{2, 3}}, zv{-2, -3}},
		{`{x+y}.(1 2;3 4)`, l{".", l{"λ", l{l{"+", "x", "y"}}}, l{nil, zv{1, 2}, zv{3, 4}}}, zv{4, 6}},
		{`{x<100}{2*x}\1`, l{l{`\`, l{"λ", l{l{"*", z2, "x"}}}}, l{"λ", l{l{"<", "x", c(100, 0)}}}, z1}, zv{1, 2, 4, 8, 16, 32, 64, 128}},
	}
