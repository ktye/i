...
func TestB(t *testing.T) {
	testCases := []struct {
		...
		{"0:I", "x::5", "2000 410274 4105 360200"},
		{"0:I", "(x,1)::C 5", "2000 410274 41016a 4114 2d0000 3a0000"},
		
		{"0:I", "(x,1)::5", "2000 4101 6a 410274 4105 360200"},
		{"0:I", "(x,1)::5.", "2000 4101 6a 74 4105 360200"},

		{"0:I", "(0,1)::5", "2000 4102 74 4105 360200"},
