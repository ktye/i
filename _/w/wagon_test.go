...
func hostFuncs(name string) (*wasm.Module, error) { // imported as module "ext"
	...
	exp := func(proc *exec.Process, x float64) float64 { return math.Exp(x) }
	...
	m.FunctionIndexSpace = []wasm.Function{
		...
		{Sig: &m.Types.Entries[0], Host: reflect.ValueOf(exp), Body: &wasm.FunctionBody{}},
	...
	m.Export = &wasm.SectionExports{
		Entries: map[string]wasm.ExportEntry{
			...
			"exp":    {FieldStr: "exp", Kind: wasm.ExternalFunction, Index: 2},
			"log":    {FieldStr: "log", Kind: wasm.ExternalFunction, Index: 3},
			"atan2":  {FieldStr: "atan2", Kind: wasm.ExternalFunction, Index: 4},
			"hypot":  {FieldStr: "hypot", Kind: wasm.ExternalFunction, Index: 5},
			"draw":   {FieldStr: "draw", Kind: wasm.ExternalFunction, Index: 6},
			"grow":   {FieldStr: "grow", Kind: wasm.ExternalFunction, Index: 7},
			"printc": {FieldStr: "printc", Kind: wasm.ExternalFunction, Index: 8},
		},
	}
	return m, nil
}
