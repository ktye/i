...
j:I:I{(~I 0)? :ii x;s:I 8;p:I s0;t:I s1;(1~I s4)?((41~x)?s4::0;rz);(40~x)?(s4::1;rz);
 n:I s2;(47<x)?(58>x)?(x-:48;(~x|n)?(t:pc 1;rz);n*:10;n+:x;s2::n;rz);n?(t:pc 1|n<<1;s2::0);
 y:I s3;(96<x)?(123>x)?(y*:32;y+:x-96;s3::y;rz);y?(t:pc 2|y<<2;s3::0);
 (33>x)?((10~x)?((~t~p)?!;ex p;s0::mk 0;s1::I s+8; :1);rz);
 (91~x)?(t:pc mk 0;s1::I(pl t);rz);(93~x)?(t:pa t;(~t)?!;s1::t;rz);t:pc 4|(x-33)<<3;0}
...
ex.V:I{(~xl)?!;r:0;p:x+8;l:x;nx?l:pl x;
 ...
 dx x;dx r}  tc:{dx x;x:po;p:x+4;l:pl x}

ii.I:I{0::x;p:128;i:7;(i<x)?/((4*i)::p;p*:2;i+:1);4::mk sz;(4+I 4)::0;s:mk 5;(8+s)::mk 0;(12+s)::I s+8;8::s;12::mk 0;x}
...
pa.I:I{p:I 8+I 8;1?/((~nn p)? :p;l:I(pl p);((l~x)+(~l)+p~x)? :p;p:l);p}cp.I:III{x+:8;y+:8;z/(y::rx I x;x+:4;y+:4);y}
