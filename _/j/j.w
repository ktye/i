...
ii.I:I{0::x;p:128;i:7;(i<x)?/((4*i)::p;p*:2);4::mk sz;(4+I 4)::0;12::mk 0;s:mk 5;(8+s)::mk 0;(12+s)::I s+8;x}sz:{124}  /init, 64k: ii(16)
...
lc.I:II{n:nx;(1~I x)?((bk 1+n)~bk n)?((8+x+4*n)::y;(4+x)::1+n; :x);r:mk 1+n;xp:8+x;rp:8+r;n/(rp::rx I xp;rp+:4;xp+:4);rp::y;dx x;r}
...
po:{(pop x)}pop.I:I{x:I 4;n:nx;(~n)?!;r:I(pl x);(4+x)::n-1;r}
