...
kst:I:I{t:tp x;(7~t)?(rx x; :((kst til x)cc 33)ucat kst val x);$[6~t;x:x ech 235;x:str x];t?[r:x;r:((mkc 34)ucat x)cc 34;;;;r:(mkc 96)ucat x jon mkc 96;r:((mkc 40)ucat x jon mkc 59)cc 41;r:x jon mkc 32];r}
