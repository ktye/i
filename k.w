...
nec.V:II{c:C x;$[crbz c;y::C?c+32;y::C?c]}nei.V:II{y::0-I x}nef.V:II{y::-F x}nez.V:II{y::-F x;(y+8)::-F x+8}
...
pui.I:III{(~x is 4)? :0;((x is 4)*y<z)?/(r*:10;r+:I?x-48;y+:1;x:C y);(r~0)?(120~x)? :0;8::y;r}
