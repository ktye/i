...
cal:I:II{v2;xt? :x atm y;(~yt~6)?!;(yn~1)?(((sadv x)|sadv x-128)? :((I.x)(fst y));(x<128)?x+:128);(x<128)?((~yn~2)?!;rld y; :(I.x)(I yp;I yp+4));(x<256)?((~yn~1)?!; :(I.x)(fst y));(xn~2)?(rld x;a:I xp;yn?[; :((I.a+128)(fst y;I xp+4));(rld y; :((I.a)(I yp;I yp+4;I xp+4)));!]);(xn~3)?(rl x;r:asi(I x+12;I x+16;y);v:I x+8;dx x; :v cal r);(xn~4)? :lcl(x;y;0);!;x}
lcl:I:III{fn:I x+20;(z+~fn)?(dx y;y:6 mk fn);(~fn~nn y)?!;a:I x+16;rx a;t:I x+12;rx t;an:nn I x+16;(fn<an)?(an-fn)/y:y lcat 0;d:a mkd y;r:lst t lev d;dx x;z?(dx r; :d);dx d;r}
rev:I:I{(7~tp x)?(rld x;:(rev I x+8)mkd rev I x+12);n:nn x;(~n)? :x;x atx tir n}fst:I:I{v1;(~xt)? :x;(xt~7)?( :fst val x);x atx mki 0}lst:I:I{(7~tp x)? :lst val x;x atx mki (nn x)-1}
...
muc:V:III{z::(C x)*C y}mui:V:III{z::(I x)*I y}muf:V:III{z::(F x)*F y}muz:V:III{z::((F x)*F y)-(F y+8)*F x+8;(z+8)::((F x)*F y+8)+(F x+8)*F y}
dic:V:III{z::(C x)%C y}dii:V:III{z::(I x)%I y}dif:V:III{z::(F x)%F y}moi:V:III{x:I x;y:I y;z::(y+I?x\'y)\'y}
...
ovr:I:II{(2~tp y)? :x mod y;ovs(x;y;0;0)}scn:I:II{(2~tp y)? :x diw y;ovs(x;y;enl 6 mk 0;0)}ovi:I:III{ovs(y;z;0;x)}sci:I:III{ovs(y;z;enl 6 mk 0;x)}scl:V:II{x?(rx y;xp:x+8;xp::(I xp)lcat y)}
...
evl:I:II{v1;(~xt~6)?((xt~5)?(xn~1)?(r:x lup y;(~r)?!; :r); :x);(~xn)? :x;(xn~1)? :(fst x)lev y;v:I xp;(v~36)?(xn>3)?  :x swc y;r:ras(x;xn;y);r? :asd(r;y);x:x lev y;xn:nn x;xp:x+8;(v~128)?(xn>2)? :lst x;(xn~2)?(rl x;r:(I xp)atx I xp+4;dx x; :r);a:(xp+4)fnl xn-1;a? :x prj a;rx I xp;(I xp)cal x drop 1}
prj:I:II{r:0 mk 3;rx I x+8;(r+8)::I x+8;(r+12)::x drop 1;(r+16)::y;r}
...
cg:I:II{((~x)+x~128)? :1 mk 0;(x<127)? :mkc x;(x<256)? :(mkc x-128)cc 58;(y~3)?(rl x;dx I x+16;r:kst I x+12;(r+8)::C?91;(r+7+nn r)::C?93;r:(str I x+8)ucat r;dx x; :r);(~y~4)?!;r:I x+8;rx r;r}
ci:I:II{(~x)? :mkc 48;m:0;(x<'0)?(x:0-x;m:1);r:1 mk 0;x?/(c:x\10;c?y:0;(~y)?r:r cc 48+c;x%:10);(~nn r)?r:r cc 48;(rev r)ng m}
cf:I:F{(~x~x)? :(mkc 48)cc 110;(x~0.0)? :((mkc 48)cc 46)cc 48;m:0;(x<0.0)?(m:1;x:-x);(x>9218868437227405311f)? :((mkc 48)cc 119)ng m;e:0;(x>1000.0)?/(e+:3;x%:1000.0);(x<1.0)?((x>=0.01)?(r:(mkc 48)cc 46;(x<0.1)?(r:r cc 48;x*:10.0);x*:10000000.0; :(r ucat(I?x)ci 1)ng m);(x<1.0)?/(e-:3;x*:1000.0));n:I?'x;r:n ci 0;x-:F?n;d:7-nn r;(d<'1)?d:1;d/x*:10.0;r:(r cc 46)ucat(I?x)ci 1;e?r:(r cc 101)ucat e ci 0;r ng m}
cz:I:FF{a:x hypot y;p:I?0.5+x ang y;((cf a)cc 97)ucat p ci 0}
...
num:I:III{r:pfl(x;y;z);(~r)? :r;y:I 8;(97~C y)?((2~tp r)?r:up(r;2;1);y+:1;8::y;r:up(r;3;1);a:pfl(C y;y;z);(~a)?a:mki 0;(2~tp a)?a:up(a;2;1);r:r atx a);r}
